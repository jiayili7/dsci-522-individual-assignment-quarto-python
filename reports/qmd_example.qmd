...
Additionally, note that in @tbl-sd we consider the sample standard deviation of the number of horses during the same time span as @fig-horse-population.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-largest-sd}

In @fig-largest-sd we zoom in and look at the province of `{python} Markdown(largest_sd)`, which had the largest spread of values in terms of standard deviation.
